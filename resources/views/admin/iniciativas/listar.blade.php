                    ...
                    <div class="card">
                        <div class="card-header">
                            ...
                            <div class="card-header-action">
                                ...
                                <a type="button" class="btn btn-primary" href="{{ route('admin.paso1.crear') }}"><i
                                        class="fas fa-plus"></i> Nueva iniciativa</a>
                            </div>
                        </div>
                        <div class="card-body">
                            <div class="row">
                            ...
                            <form action="{{ route('admin.iniciativas.index') }}" method="GET">
                                <div class="row">
                                    <div class="col-xl-2 col-md-2 col-lg-2" id="select-region">
                                        <div class="form-group">
                                            <label>Región</label>
                                            <select class="form-control select2" id="region" name="region"
                                                style="width: 100%" onchange="consultarComunas()">
                                    ...
                                    <div class="col-xl-2 col-md-2 col-lg-2">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control select2" id="comuna" name="comuna"
                                                style="width: 100%" onchange="consultarUnidades()">
                                                <option value="" selected disabled>Seleccione...</option>
                                            ...
                                            <select class="form-control select2" id="unidad" name="unidad"
                                                ...
                                                @forelse ($unidades as $unidad)
                                                    <option value="{{ $unidad->unid_codigo }}"
                                                        {{ Request::get('unidad') == $unidad->unid_codigo ? 'selected' : '' }}>
                                    ...
                                    <div class="col-xl-2 col-md-2 col-lg-2">
                                        <div class="form-group">
                                            ...
                                            <input type="date" class="form-control datepicker" style="width: 100%"
                                    ...
                                    <div class="col-xl-12 col-md-12 col-lg-12 text-right mb-4">
                                                    ...
                                                    <td>
                                                        ...
                                                        @else
                                                            @if ($iniciativa->inic_aprobada == 'S')
                                                                <div class="badge badge-success badge-shadow">Aprobada
                                                                </div>
                                                            @else
                                                                <div class="badge badge-danger badge-shadow">Rechazada
                                                                </div>
                                                            @endif
                                                        @endif
                                                    </td>
                                                        ...
                                                        <div class="dropdown d-inline">
                                                            ...
                                                            <div class="dropdown-menu dropright">
                                                                <a class="dropdown-item has-icon"
                                                                    href="{{ route('admin.paso1.editar', $iniciativa->inic_codigo) }}"><i
                                                                        class="fas fa-edit"></i> Editar iniciativa</a>
                                                                <a href="javascript:void(0)"
                                                                    class="dropdown-item has-icon"
                                                                    onclick="eliminarIniciativa({{ $iniciativa->inic_codigo }})"><i
                                                                        class="fas fa-trash"></i>Eliminar iniciativa</a>
                                                            </div>
                                                        </div>
                                                        <a href="{{ route('admin.iniciativas.show', $iniciativa->inic_codigo) }}"
