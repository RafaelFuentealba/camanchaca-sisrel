            ...
            <div class="row">
                <div class="col-12 col-md-12 col-lg-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            @if (isset($iniciativa))
                                <form action="{{ route('admin.paso1.actualizar', $iniciativa->inic_codigo) }}"
                                    method="POST">
                                    @method('PUT')
                                    @csrf
                                @else
                            ...
                            <div class="row">
                                <div class="col-xl-12 col-md-12 col-lg-12">
                                    <div class="form-group">
                                        <label>Nombre de actividad</label> <label for=""
                                    ...
                                    <div class="form-group">
                                        <label>Descripción y objetivos</label> <label for=""
                                            style="color: red;">*</label>
                                ...
                                <div class="col-xl-3 col-md-3 col-lg-3">
                                    <div class="form-group">
                                        ...
                                        <input type="date" class="form-control" id="fechainicio" name="fechainicio"
                                            value="{{ old('fechainicio') ?? @\Carbon\Carbon::parse($iniciativa->inic_fecha_inicio)->format('Y-m-d') }}">
                                ...
                                <div class="col-xl-3 col-md-3 col-lg-3">
                                    <div class="form-group">
                                        ...
                                        <input type="date" class="form-control" id="fechafin" name="fechafin"
                                            value="{{ old('fechafin') ?? @\Carbon\Carbon::parse($iniciativa->inic_fecha_fin)->format('Y-m-d') }}">
                                    </div>
                                </div>
                                <div class="col-xl-3 col-md-3 col-lg-3">
                                    <div class="form-group">
                                        ...
                                        @if (isset($iniciativa))
                                            <select class="form-control select2" id="frecuencia" name="frecuencia"
                                                ...
                                                @forelse ($frecuencias as $frecuencia)
                                                    <option value="{{ $frecuencia->frec_codigo }}"
                                                        {{ $iniciativa->frec_codigo == $frecuencia->frec_codigo ? 'selected' : '' }}>
                                                        {{ $frecuencia->frec_nombre }}</option>
                                                @empty
                                        ...
                                        @else
                                            <select class="form-control select2" id="frecuencia" name="frecuencia"
                                                ...
                                                @forelse ($frecuencias as $frecuencia)
                                                    <option value="{{ $frecuencia->frec_codigo }}"
                                                        {{ old('frecuencia') == $frecuencia->frec_codigo ? 'selected' : '' }}>
                                                        {{ $frecuencia->frec_nombre }}</option>
                                                @empty
                                                    <option value="-1">No existen registros</option>
                                                @endforelse
                                    ...
                                    <div class="form-group">
                                        ...
                                        @if (isset($iniciativa))
                                            <select class="form-control select2" id="pilar" name="pilar"
                                                ...
                                                @forelse ($pilares as $pilar)
                                                    <option value="{{ $pilar->pila_codigo }}"
                                                        {{ $iniciativa->pila_codigo == $pilar->pila_codigo ? 'selected' : '' }}>
                                                        {{ $pilar->pila_nombre }}</option>
                                                @empty
                                                    <option value="-1">No existen registros</option>
                                                @endforelse
                                            </select>
                                        @else
                                            <select class="form-control select2" id="pilar" name="pilar"
                                                ...
                                                @forelse ($pilares as $pilar)
                                                    <option value="{{ $pilar->pila_codigo }}"
                                                        {{ old('pilar') == $pilar->pila_codigo ? 'selected' : '' }}>
                                                        {{ $pilar->pila_nombre }}</option>
                                                @empty
                                                    <option value="-1">No existen registros</option>
                                                @endforelse
                            ...
                            <div class="row">
                                <div class="col-xl-4 col-md-4 col-lg-4">
                                    <div class="form-group">
                                        ...
                                        @if (isset($iniciativa))
                                            <select class="form-control select2" multiple="" id="unidad"
                                                name="unidad[]" style="width: 100%">
                                                @forelse ($unidades as $unidad)
                                                    <option value="{{ $unidad->unid_codigo }}"
                                                        {{ in_array($unidad->unid_codigo, $iniciativasUnidades) ? 'selected' : '' }}>
                                                        {{ $unidad->unid_nombre }} ({{ $unidad->comu_nombre }})</option>
                                                @empty
                                                    <option value="-1">No existen registros</option>
                                                @endforelse
                                            </select>
                                        @else
                                            <select class="form-control select2" multiple="" id="unidad"
                                                ...
                                                @forelse ($unidades as $unidad)
                                                    <option value="{{ $unidad->unid_codigo }}"
                                                        {{ collect(old('unidad'))->contains($unidad->unid_codigo) ? 'selected' : '' }}>
                                                        {{ $unidad->unid_nombre }} ({{ $unidad->comu_nombre }})</option>
                                                @empty
                                                    <option value="-1">No existen registros</option>
                                                @endforelse
                                    ...
                                    <div class="form-group">
                                        ...
                                        @if (isset($iniciativa))
                                            <select class="form-control select2" id="submecanismo" name="submecanismo"
                                                ...
                                                @forelse ($actividades as $actividad)
                                                    <option value="{{ $actividad->subm_codigo }}"
                                                        {{ $iniciativa->subm_codigo == $actividad->subm_codigo ? 'selected' : '' }}>
                                                        {{ $actividad->subm_nombre }} ({{ $actividad->meca_nombre }})
                                                    </option>
                                                @empty
                                                    <option value="-1">No existen registros</option>
                                                @endforelse
                                        ...
                                        @else
                                            <select class="form-control select2" id="submecanismo" name="submecanismo"
                                                ...
                                                @forelse ($actividades as $actividad)
                                                    <option value="{{ $actividad->subm_codigo }}"
                                                        {{ old('submecanismo') == $actividad->subm_codigo ? 'selected' : '' }}>
                                                        {{ $actividad->subm_nombre }} ({{ $actividad->meca_nombre }})
                                                    </option>
                                                @empty
                                                    <option value="-1">No existen registros</option>
                            ...
                            <div class="row">
                                <div class="col-xl-4 col-md-4 col-lg-4">
                                    <div class="form-group">
                                        <label>Formato de implementación</label> <label for=""
                                            style="color: red;">*</label>
                                        @if (isset($iniciativa))
                                            <select class="form-control select2" id="implementacion"
                                                name="implementacion" style="width: 100%">
                                                <option value="" selected disabled>Seleccione...</option>
                                                @forelse ($formatos as $formato)
                                                    <option value="{{ $formato->foim_codigo }}"
                                                        {{ $iniciativa->foim_codigo == $formato->foim_codigo ? 'selected' : '' }}>
                                                        {{ $formato->foim_nombre }}</option>
                                                @empty
                                                    <option value="-1">No existen registros</option>
                                                @endforelse
                                            </select>
                                        @else
                                            <select class="form-control select2" id="implementacion"
                                                ...
                                                @forelse ($formatos as $formato)
                                                    <option value="{{ $formato->foim_codigo }}"
                                                        {{ old('implementacion') == $formato->foim_codigo ? 'selected' : '' }}>
                                                        {{ $formato->foim_nombre }}</option>
                                                @empty
                                                    <option value="-1">No existen registros</option>
                                                @endforelse
                                ...
                                <div class="col-xl-4 col-md-4 col-lg-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="nombreresponsable"
                                            ...
                                            value="{{ old('nombreresponsable') ?? @$iniciativa->inic_nombre_responsable }}">
                                ...
                                <div class="col-xl-4 col-md-4 col-lg-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="cargoresponsable"
                                            name="cargoresponsable"
                                            value="{{ old('cargoresponsable') ?? @$iniciativa->inic_cargo_responsable }}">
                            ...
                            <div class="row">
                                <div class="col-xl-12 col-md-12 col-lg-12">
                                    <div class="text-right">
                                        ...
                                        @else
                                            <a href="{{ route('admin.paso1.crear') }}" type="button"
