                ...
                <div class="col-xl-12">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <h4>{{ $iniciativa->inic_nombre }} - Listado de evidencias</h4>
                            ...
                            <div class="card-header-action">
                                <div class="dropdown d-inline">
                                    ...
                                    <a href="{{ route('admin.dbgeneral.index') }}" type="button"
                                        class="btn btn-warning mr-1 waves-effect"><i class="fas fa-home"></i> Volver a
                                        inicio</a>
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{ route('admin.evidencia.guardar', $iniciativa->inic_codigo) }}" method="POST"
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <textarea class="formbold-form-input" id="inev_descripcion" name="inev_descripcion" rows="3"
                ...
                <div class="modal-body">
                    <form method="POST" id="form-editar-evidencia">
                        ...
                        <div class="form-group">
                            <label>Descripción</label>
                            <div class="input-group">
                                <textarea class="formbold-form-input" id="inev_descripcion_edit" name="inev_descripcion_edit" rows="3"
                                    style="width: 100%;"></textarea>
                            </div>
                        </div>
                        <div class="text-center">
